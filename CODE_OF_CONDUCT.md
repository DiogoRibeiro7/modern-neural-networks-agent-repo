...
Because this is a scientific repository, the following also count as unacceptable conduct:

- knowingly misrepresenting experimental results, baselines, or claim levels;
- pressuring contributors to remove negative results or documented limitations.
...
community leaders responsible for enforcement at `hansolo.dj@gmail.com`. All complaints will
